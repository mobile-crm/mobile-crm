...
<table align="center" border="0" style="padding-top:15px;">	
	...
	<tr><td>json存储配置内容:</td><td><input name="configContent" id="configContent" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>1提示语配置:</td><td><input name="configType" id="configType" type="text" size="60" maxlength="50" /></td></tr>
